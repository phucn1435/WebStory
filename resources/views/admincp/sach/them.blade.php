...
@section('content1')
    ...
    <form action="{{ route('sach.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="tensach" onkeyup="ChangeToSlug();" id="slug" aria-describedby="emailHelp">
        </div>
        @error('tendanhmuc')
        ...
        <div class="mb-3">
            ...
            <input id="convert_slug" type="text" class="form-control" name="slug_sach" aria-describedby="emailHelp">
        </div>
        ...
        <div class="mb-3">
            <label for="exampleInputEmail2" class="form-label">Tóm tắt sách</label>
        ...
        <div class="mb-3">
            <label for="exampleInputEmail2" class="form-label">Hình ảnh sách</label>
