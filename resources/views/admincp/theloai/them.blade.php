...
@section('content1')
    ...
    <form action="{{ route('theloai.store') }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" name="tentheloai" onkeyup="ChangeToSlug();" id="slug" aria-describedby="emailHelp">
        </div>
        @error('tendanhmuc')
        ...
        <div class="mb-3">
            ...
            <input id="convert_slug" type="text" class="form-control" name="slug_theloai"  aria-describedby="emailHelp">
        </div>

        <div class="mb-3">
            <label for="exampleInputEmail2" class="form-label">Mô tả thể loại</label>
