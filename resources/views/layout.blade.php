...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  ...
  <script src="https://maxcdn.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js"></script>    --}}
        ...
        <script>
            $('#switch_theme_color').change(function() {
                var color_theme = $(this).val();
                // alert(color_theme);
                $(document.body).toggleClass('switch_theme_black');
            });
        </script>
        <script>
            show_wishlist();
            ...
            function show_wishlist() {
                ...
                for (i = 0; i < data.length; i++) {
                    ...
                    var id = data[i].id;
                    var url = data[i].url;
                    $('#yeuthich').append(`<div class="row mt-2"> 
        ...
        <script>
            $('.click_link').click(function(){
                ...
                $.ajax({
                    ...
                    success:function(data) {
                       $('.show_cate_'+danhmuc_id).html(data);
                    }
                });
            }); 
        </script>
        <div id="fb-root"></div>
        <script async defer crossorigin="anonymous" src="https://connect.facebook.net/vi_VN/sdk.js#xfbml=1&version=v18.0" nonce="Yq6BwCB5"></script>
